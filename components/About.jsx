      ...
      <div className="max-w-7xl mx-auto px-8 md:px-16">
        ...
        >
          ...
          <h2 className="font-sans text-5xl md:text-7xl lg:text-8xl text-ivory tracking-wider font-light flex items-center gap-6 md:gap-8">
            ABOUT <span className="font-serif italic text-saffron/80 lowercase tracking-normal">the</span> TOUR
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              <div className="flex -space-x-4">
                <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-midnight relative z-20">
                  <Image src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=100&q=80" alt="Host" fill className="object-cover" />
                </div>
                <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-midnight relative z-10">
                  <Image src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=100&q=80" alt="Host" fill className="object-cover" />
                </div>
              </div>
              <div>
          ...
          <div className="relative h-[500px] md:h-[600px] flex justify-center lg:justify-end items-center mt-12 lg:mt-0">
            ...
            >
              <Image src="https://images.unsplash.com/photo-1514222134-b57cbb8ce073?auto=format&fit=crop&w=600&q=80" alt="India temple" fill className="object-cover" />
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, y: -40 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <Image src="https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&w=600&q=80" alt="India street" fill className="object-cover" />
            </motion.div>
          </div>
        </div>
      </div>
