        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-[220px]">
          {handledItems.map((item, index) => (
            <FadeIn
              ...
              duration={0.6}
              y={20}
              className={`${item.size} ${item.bg} rounded-[2rem] p-10 border border-white/5 flex flex-col justify-between group hover:border-saffron/30 transition-colors duration-500`}
            >
